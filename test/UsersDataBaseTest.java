...
public class UsersDataBaseTest {
    ...
    public void testMyLibraryNumber() throws Exception {
        ...
        assertEquals(libraryNumber, new UsersDataBase().getLibraryNumber(libraryNumber, password));        
    }
    ...
    public void testMyLibraryNumberWithWrongPassword() throws Exception {
        ...
        assertNull(new UsersDataBase().getLibraryNumber(libraryNumber, password));
    }
